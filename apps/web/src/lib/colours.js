...
export const categoryColours = {
  ...
  autoscalingInternalKnativeDev: 'rgba(33, 150, 243, 1)',
  batch: 'rgba(0, 150, 136, 1)',
  telemetryIstioIo: 'rgba(0, 150, 136, 1)',
  certificates: 'rgba(205, 220, 57, 1)',
  cachingInternalKnativeDev: 'rgba(205, 220, 57, 1)',
  ...
  networkingInternalKnativeDev: 'rgba(51, 105, 30, 1)',
  node: 'rgba(53, 105, 30, 1)',
  policy: 'rgba(255, 111, 0, 1)',
  rbacAuthorization: 'rgba(244, 67, 54, 1)',
  operatorKnativeDev: 'rgba(244, 67, 54, 1)',
  scheduling: 'rgba(103, 58, 183, 1)',
  servingKnativeDev: 'rgba(103, 58, 183, 1)',
